...
#[derive(Debug)]
pub struct ChainSyncProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainSyncProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainSync processing");
    
    let mut processor = ChainSyncProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainSyncProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainSyncProcessor::new(false);
